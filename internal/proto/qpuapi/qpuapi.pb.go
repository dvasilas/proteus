...
var file_qpuapi_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x32, 0xdd, 0x03, 0x0a, 0x06, 0x51, 0x50, 0x55,
	...
	0x6f, 0x67, 0x4f, 0x70, 0x22, 0x00, 0x30, 0x01, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x76, 0x61, 0x73, 0x69, 0x6c, 0x61, 0x73, 0x2f,
	0x70, 0x72, 0x6f, 0x74, 0x65, 0x75, 0x73, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x71, 0x70, 0x75, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70,
...
var file_qpuapi_proto_goTypes = []interface{}{
	...
	(*qpuextapi.QueryResp)(nil),                // 23: qpuextapi.QueryResp
	(*qpuextapi.QueryResp1)(nil),               // 24: qpuextapi.QueryResp1
	(*qpuextapi.MetricsResponse)(nil),          // 25: qpuextapi.MetricsResponse
	(*qpuextapi.WriteLogOp)(nil),               // 26: qpuextapi.WriteLogOp
}
var file_qpuapi_proto_depIdxs = []int32{
	...
	11, // 23: qpuapi.QPUAPI.Query:output_type -> qpuapi.ResponseStreamRecord
	23, // 24: qpuapi.QPUAPI.QueryUnary:output_type -> qpuextapi.QueryResp
	24, // 25: qpuapi.QPUAPI.QueryUnary1:output_type -> qpuextapi.QueryResp1
	11, // 26: qpuapi.QPUAPI.QuerySubscribe:output_type -> qpuapi.ResponseStreamRecord
	14, // 27: qpuapi.QPUAPI.GetConfig:output_type -> qpuapi.ConfigResponse
	25, // 28: qpuapi.QPUAPI.GetMetrics:output_type -> qpuextapi.MetricsResponse
	26, // 29: qpuapi.QPUAPI.GetWriteLog:output_type -> qpuextapi.WriteLogOp
