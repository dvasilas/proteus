...
func (m *QueryInternalQuery) GetClock() *utils.SnapshotTimePredicate {
	if m != nil {
		return m.Clock
	}
	return nil
...
func (m *QueryInternalQuery) GetPredicate() []*utils.AttributePredicate {
	if m != nil {
		return m.Predicate
	}
	return nil
...
func (*Query_SQLQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_0be19c925dafeffa, []int{5, 1}
}
...
func (*DataSet_DB) Descriptor() ([]byte, []int) {
	return fileDescriptor_0be19c925dafeffa, []int{9, 0}
}
...
func (*DataSet_DC) Descriptor() ([]byte, []int) {
	return fileDescriptor_0be19c925dafeffa, []int{9, 1}
}
...
func (*PingMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_0be19c925dafeffa, []int{10}
}
...
func init() {
	...
	proto.RegisterType((*Query)(nil), "qpu.Query")
	proto.RegisterType((*QueryInternalQuery)(nil), "qpu.Query.internalQuery")
	proto.RegisterType((*Query_SQLQuery)(nil), "qpu.Query.SQLQuery")
...
var fileDescriptor_0be19c925dafeffa = []byte{
	...
	,
}
